...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/types/config.go#L20-L29
```
...
```go reference
https://github.com/depinnetwork/por-consensus/blob/v1.0.0-rc1/libs/cli/setup.go#L74-L78
```

See an example of `main` function from the `simapp` application, the Cosmos SDK's application for demo purposes:

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/simapp/simd/main.go
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/server/start.go#L201
```

Note that an `appCreator` is a function that fulfills the `AppCreator` signature:

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/server/types/app.go#L69-L71
```
