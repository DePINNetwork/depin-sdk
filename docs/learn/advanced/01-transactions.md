...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/types/tx_msg.go#L53-L66
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/proto/cosmos/tx/v1beta1/tx.proto#L15-L28
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/auth/migrations/legacytx/stdtx.go#L81-L91
```

The document signed by all signers is `StdSignDoc`:

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/auth/migrations/legacytx/stdsign.go#L32-L45
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/proto/cosmos/tx/v1beta1/tx.proto#L69-L93
```
...
There is the opportunity to add your own custom sign mode to the Cosmos-SDK.  While we can not accept the implementation of the sign mode to the repository, we can accept a pull request to add the custom signmode to the SignMode enum located [here](https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/proto/cosmos/tx/signing/v1beta1/signing.proto#L9-L17)
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/client/tx_config.go#L39-L57
```
...
* [builder](https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/auth/tx/builder.go#L79-L98) for creating transactions for `SIGN_MODE_DIRECT`,
* [StdTxBuilder](https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/auth/migrations/legacytx/stdtx_builder.go#L11-L17) for `SIGN_MODE_LEGACY_AMINO_JSON`.
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/client/tx_config.go#L27-L37
```
...
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/proto/cosmos/tx/v1beta1/service.proto
