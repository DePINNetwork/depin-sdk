...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/server/types/app.go#L45-L47
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/bank/proto/cosmos/bank/v1beta1/query.proto#L23-L30
```
...
The Cosmos SDK's [Swagger generation script](https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/scripts/protoc-swagger-gen.sh) is a good place to start.
