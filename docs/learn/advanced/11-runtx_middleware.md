...
More context can found in the corresponding [ADR-022](../../architecture/adr-022-custom-panic-handling.md) and the implementation in [recovery.go](https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/baseapp/recovery.go).

## Interface

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/baseapp/recovery.go#L14-L17
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/baseapp/baseapp.go#L549-L554
```
