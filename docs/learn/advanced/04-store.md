...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L15-L18
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L287-L303
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L32-L36
```

The `Committer` is an interface that defines methods to persist changes to disk:

```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L20-L30
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L123-L155
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L163-L227
```

As for concrete implementation, the [`rootMulti.Store`](https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/rootmulti/store.go) is the go-to implementation of the `CommitMultiStore` interface.

```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/rootmulti/store.go#L55-L77
```
...
Whenever the `rootMulti.Store` needs to be branched, a [`cachemulti.Store`](https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/cachemulti/store.go) is used.

```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/cachemulti/store.go#L20-L33
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/store.go#L229-L266
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.2/x/bank/keeper/view.go#L114-L134
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/dbadapter/store.go#L13-L16
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/cachekv/store.go#L26-L35
```
...
Cosmos SDK applications use [`gas`](../beginner/04-gas-fees.md) to track resources usage and prevent spam. [`GasKv.Store`](https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/gaskv/store.go) is a `KVStore` wrapper that enables automatic gas consumption each time a read or write to the store is made. It is the solution of choice to track storage usage in Cosmos SDK applications.

```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/gaskv/store.go#L11-L17
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/types/gas.go#L220-L229
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/tracekv/store.go#L20-L43
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/prefix/store.go#L15-L21
```
...
Additional information about state streaming configuration can be found in the [store/streaming/README.md](https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/streaming/README.md).

```go reference
https://github.com/depinnetwork/depin-sdk/blob/store/v1.1.1/store/listenkv/store.go#L11-L18
```
