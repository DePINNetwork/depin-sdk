...
Note: **v0.52** relies on [Comet v1](https://github.com/depinnetwork/por-consensus/releases/tag/v1.0.0)
...
* If you have custom modules using `params`, see the [migration reference](https://github.com/depinnetwork/depin-sdk/blob/828fcf2f05db0c4759ed370852b6dacc589ea472/x/mint/migrations/v2/migrate.go) for how to adapt to module-managed parameters.
...
* Replace import paths from github.com/depinnetwork/depin-sdk/x/{moduleName} to cosmossdk.io/x/{moduleName}.
* Example:

```diff
- import govtypes "github.com/depinnetwork/depin-sdk/x/gov/types"
...
The interface HasProposalMsgs has been renamed to HasLegacyProposalMsgs, as we've introduced a new simulation framework, simpler and easier to use, named [simsx](https://github.com/depinnetwork/depin-sdk/tree/main/simsx).
...
Modules within the Cosmos SDK were migrated to use [collections](https://github.com/depinnetwork/depin-sdk/tree/main/collections). It is not required to migrate your own modules, but it is recommended to use collections for future modules. 
