...
With the deprecation of [`GetSigners`](https://github.com/depinnetwork/depin-sdk/issues/11275) we have the optionality to remove [sdk.Msg](https://github.com/depinnetwork/depin-sdk/blob/16a5404f8e00ddcf8857c8a55dca2f7c109c29bc/types/tx_msg.go#L16) and the `ValidateBasic` function. 
