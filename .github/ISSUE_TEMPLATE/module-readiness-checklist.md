...
- [ ] API audit (at least 1 person) (@assignee)
  ...
  - [ ] Is everything well documented (inline godoc as well as the spec [README.md](https://github.com/depinnetwork/depin-sdk/blob/main/docs/spec/README.md) in module directory)
