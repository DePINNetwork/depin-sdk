...
```bash
go test -v --bench github.com/depinnetwork/depin-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/depinnetwork/depin-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/depinnetwork/depin-sdk/crypto/keys/mintkey	12.093s
```
