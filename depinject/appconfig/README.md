...
message Module {
  option (cosmos.app.v1alpha1.module) = {
    go_import: "github.com/depinnetwork/depin-sdk/x/auth"
  };
...
Alternatively, the `depinject.Config` can be created via [pure Go code](https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/simapp/app_config.go).
