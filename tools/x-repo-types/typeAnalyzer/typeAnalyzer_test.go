...
func TestBuildWithCyclicCheck(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			x:    Node{},
			path: []string{
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Node\" (struct)",
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Node\" (struct)",
			},
		},
		{
			...
			x:    Senior{},
			path: []string{
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Senior\" (struct)",
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Parent\" (struct)",
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Child\" (struct)",
				"github.com/DePINNetwork/depin-sdk/tools/x-repo-types/typeAnalyzer :: \"main.Senior\" (struct)",
			},
		},
		{
