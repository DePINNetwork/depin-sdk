...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/x/circuit/v0.1.0/x/circuit/ante/circuit.go#L27-L41
``` 

* With a [message router check](https://docs.cosmos.network/main/learn/advanced/baseapp#msg-service-router):

```go reference
https://github.com/depinnetwork/depin-sdk/blob/release/v0.52.x/baseapp/msg_service_router.go#L123-L133
``` 
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/release/v0.52.x/x/circuit/proto/cosmos/circuit/v1/tx.proto#L25-L40
```
...
```protobuf reference 
https://github.com/depinnetwork/depin-sdk/blob/release/v0.52.x/x/circuit/proto/cosmos/circuit/v1/tx.proto#L47-L60
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/release/v0.52.x/x/circuit/proto/cosmos/circuit/v1/tx.proto#L67-L78
```
