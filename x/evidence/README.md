...
`x/evidence` is an implementation of a Cosmos SDK module, per [ADR 009](https://github.com/depinnetwork/depin-sdk/blob/main/docs/architecture/adr-009-evidence-module.md),
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/evidence/v1beta1/evidence.proto#L12-L32
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/x/evidence/keeper/infraction.go#L26-L140
```
