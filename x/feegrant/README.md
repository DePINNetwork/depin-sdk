...
This document specifies the fee grant module. For the full ADR, please see [Fee Grant ADR-029](https://github.com/depinnetwork/depin-sdk/blob/main/docs/architecture/adr-029-fee-grant-module.md).
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/feegrant.proto#L86-L96
```

`FeeAllowanceI` looks like:

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/fees.go#L10-L34
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/feegrant.proto#L15-L33
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/feegrant.proto#L35-L71
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/feegrant.proto#L73-L84
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/client/cmd.go#L269-L280
```

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/client/tx/tx.go#L129-L131
```

```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/auth/tx/builder.go#L208
```

```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/proto/cosmos/tx/v1beta1/tx.proto#L216-L243
```
...
```go reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/feegrant.pb.go#L222-L230
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/tx.proto#L30-L44
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/feegrant/proto/cosmos/feegrant/v1beta1/tx.proto#L49-L62
```
