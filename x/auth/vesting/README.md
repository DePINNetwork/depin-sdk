...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L11-L35
```

### ContinuousVestingAccount

```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L37-L46
```

### DelayedVestingAccount

```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L48-L57
```

### Period

```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L59-L69
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L71-L81
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/tree/release/v0.50.x/proto/cosmos/vesting/v1beta1/vesting.proto#L83-L94
```
