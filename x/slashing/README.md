...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/slashing/proto/cosmos/slashing/v1beta1/slashing.proto#L13-L35
```
...
```protobuf reference
https://github.com/depinnetwork/depin-sdk/blob/v0.52.0-beta.1/x/slashing/proto/cosmos/slashing/v1beta1/slashing.proto#L37-L62
```
...
> be changed to jailed/unjailed. See issue [#3205](https://github.com/depinnetwork/depin-sdk/issues/3205)
